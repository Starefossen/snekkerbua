...
alle 62 i referanseheftet genereres av solidene og maskinsjekkes før de får
...
| **Trevirke** | **85 stykker** i **5 dimensjoner** pluss én 18 mm kryssfinerplate — 55,07 løpemeter. Fordelingen: 23×98 34 stk. · 48×68 20 stk. · 36×48 16 stk. · 36×98 12 stk. · 48×98 2 stk. · plata 1 stk. 24 av de 85 stykkene er ett og samme stykke: spilen, 23×98 × 800 mm, kappet i én innstilling. Tallene telles av modellen og står nederst i [kapplista](docs/generated/kappliste.md) — `TOTAL 85 pcs 55.07 m in 5 timber profiles + 1 sheet` er det modellen skriver ut mens den bygger |
...
mise run pdf        # docs/hanna.pdf, 32 sider + docs/hanna-referanse.pdf, 62 sider
```
...
| `docs/hanna-referanse.pdf` | Referanseheftet på 62 sider — begrunnelsene, tallene og de øvrige tegningene. Samme sak: bygges, ikke sjekkes inn |
...
table, all 32 pages of the printed build booklet and all 62 of its reference
